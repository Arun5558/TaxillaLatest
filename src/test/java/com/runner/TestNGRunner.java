...
public class TestNGRunner {
	...
	/*
	 * TestNG - complete testng XmlSuite - test Suite XmlTest - test case under
	 * a suite XmlClass - class under test XmlInclude - include method under
	 * class
	 */
	TestNG testNg;
	...
	public void createSuite(String suiteName, boolean parallelTests) {
		...
		allSuites.add(suite);
		//suite.addListener("com.listener.MyTestNGListener");
